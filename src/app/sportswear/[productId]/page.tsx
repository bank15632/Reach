...
export default function SportswearDetailPage({ params }: { params: Promise<{ productId: string }> }) {
    ...
    const selectedColorValue = useMemo(() => {
        const entry = Object.entries(selectedVariants).find(([name]) =>
        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="pt-24 pb-4 bg-brand-black">
                <div className="max-w-7xl mx-auto px-6">
                    <Breadcrumb
                        items={[
                            { label: "SPORTSWEAR", labelTh: "ชุดกีฬา", href: "/sportswear" },
            ...
            <section className="py-8 border-t border-gray-200">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        {language === "th" ? "กลับไปหน้าชุดกีฬา" : "Back to Sportswear"}
                    </Link>
                </div>
            </section>
        </main>
